...
namespace BobGreenhands
{
    ...
    public class ExceptionHandler
    {
        ...
        {
            string template = "[[[ CRASH LOG ]]]\n{0} {1}\n\n=== System information ===\nTime: {2}\nOS: {3}\nCPU: {4}\nMemory: {5}\nGPU: {6}\n\n=== Game information ===\nResolution: {7}\nFullscreen: {8}\nCurrent Scene: {9}\nCurrent Savegame: {10}\nLogfile: {11}\n\n=== Stacktrace ===\n{12}\n\n=== Further information ===\nI'm so sorry for this inconvenience and hope that this issue won't happen again. Though not all hope is lost: all the necessary information has been collected in this file and you can even help to resolve this issue if it persists!\n**In case your game hasn't been modded**, please forward this as an issue (including this file, the aforementioned log file and the affected savegame if the crash happend mid-game) on the GitHub repo of the game under https://github.com/ManicRobot/bobgreenhands, you can find more infos in the \"Reporting bugs\" section. Otherwise, forward this issue to the modder(s) - and not me.";
